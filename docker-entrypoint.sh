...
if [ -d "$MEDIAWIKI_SHARED" ]; then
	...
	# If the images directory only contains a README, and is a link to 
	# /usr/src/mediawiki/images, then link it to $MEDIAWIKI_SHARED/images, 
	# creating the shared directory if necessary
